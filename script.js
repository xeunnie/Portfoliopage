...
function toggleProfileBox3(direction) {
    var profileWrap = document.querySelector('.profileWrap:nth-child(3)');
    if (!profileWrap) {
        console.error("Profile wrap 3 not found!");
        return;
    }

    var boxContents = profileWrap.querySelectorAll('.boxContents');
    if (boxContents.length === 0) {
        console.error("No boxContents found in profile wrap 3!");
        return;
    }
...
function toggleProfileBox4(direction) {
    var profileWrap = document.querySelector('.profileWrap:nth-child(4)');
    if (!profileWrap) {
        console.error("Profile wrap 4 not found!");
        return;
    }

    var boxContents = profileWrap.querySelectorAll('.boxContents');
    if (boxContents.length === 0) {
        console.error("No boxContents found in profile wrap 4!");
        return;
    }
